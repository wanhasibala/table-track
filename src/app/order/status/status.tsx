...
const statusSteps = [
  ...
  },
  {
    key: "confirmed",
    label: "Confirmed",
    desc: "Accepted by cashier",
    icon: CheckCircle2,
  },
  {
    key: "preparing",
    label: "Preparing",
    desc: "Kitchen is preparing your fruits",
    icon: Flame,
  },
  {
    key: "served",
    label: "Served",
    desc: "Fruits served at your table",
    icon: Utensils,
  },
  {
    key: "completed",
    label: "Completed",
    desc: "Order complete & paid",
    icon: Sparkles,
  },
];
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4 text-center">
        ...
        <p className="text-muted-foreground text-sm mt-1 max-w-xs">
          We couldn&apos;t locate this order. Please verify the URL or try
          ordering again.
        </p>
        <button
      ...
      <main className="max-w-xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-card rounded-2xl border border-border/80 shadow-md p-6 relative overflow-hidden">
            ...
            <div>
              ...
              <div className="flex flex-col gap-1 mt-1 text-xs text-muted-foreground">
                ...
                {order.type === "delivery" && order.delivery_address && (
                  <div className="mt-1.5 p-2 bg-muted/50 border border-border/40 rounded-lg text-[11px] leading-relaxed md:w-full lg:max-w-[280px]">
          ...
          {(() => {
            ...
            return (
              <div className="mt-4 p-3.5 bg-purple-500/10 border border-purple-500/25 rounded-xl text-xs space-y-1">
                ...
                <div className="text-[11px] text-muted-foreground">
                  {schedule.isFutureDay
                    ? "We have recorded your schedule and will prepare your order fresh on that date."
                    : "We will prepare your order for your scheduled time today."}
                </div>
              </div>
            );
          })()}
          ...
          {isCancelled ? (
            <div className="mt-6 p-4 rounded-xl bg-destructive/10 border border-destructive/20 flex items-center gap-3">
              ...
              <div className="text-xs text-destructive font-medium leading-relaxed">
                This order was cancelled by the store manager. Please speak to
                our staff if you believe this was an error.
              </div>
            </div>
          ) : (
            /* Vertical Stepper */
                  ...
                  <div key={step.key} className="flex gap-4 relative">
                    ...
                    <div
                      className={cn(
                        ...
                        isCurrent &&
                          "bg-card border-primary text-primary shadow-md ring-4 ring-primary/15",
                        isUpcoming &&
                          "bg-muted border-muted-foreground/30 text-muted-foreground/60",
                      )}
                    >
        ...
        <div className="bg-card rounded-2xl border border-border/80 p-5 shadow-sm space-y-3 flex items-center justify-between gap-4 animate-in fade-in duration-300">
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground leading-normal max-w-[280px]">
              Share this live order status link with your friends or tablemates
              to track food preparation.
            </p>
          </div>
          <button
            onClick={handleShare}
        ...
        {permission !== "granted" && permission !== "unsupported" && (
          <div className="bg-card rounded-2xl border border-border/80 p-5 shadow-sm space-y-3 flex items-center justify-between gap-4 animate-in fade-in duration-300">
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground leading-normal max-w-[280px]">
                Get instant notifications on your device when your fruits are
